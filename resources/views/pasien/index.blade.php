                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted mb-4 font-13">Tabel berikut menyediakan informasi detail identitas pasien.
                                            ...
                                            <div class="col-lg-2">
                                            <a href="{{url('/pasien/create')}}" class="btn btn-lg btn-success waves-effect waves-light text-light d-block"><i class="mdi mdi-pencil-box-outline mr-1"></i>Tambah Data</a>
                                            </div>
                                        </div>
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            @foreach ($pasien as $item)
                                                <tr>
                                                    ...
                                                    <a href="/pasien/{{$item->id}}" class="btn m-1 btn-sm btn-primary waves-effect waves-light text-light"><i class="mdi mdi-information-outline mr-1"></i>Detail</a>
                                                    

                                                    <a href="/pasien/{{$item->id}}/edit" class="btn m-1 btn-sm btn-info waves-effect waves-light text-light"><i class="mdi mdi-circle-edit-outline mr-1"></i>Ubah</a>
