            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-10">
                        ...
                        <p class="text-muted mb-4 font-13">Tabel berikut menyediakan informasi detail Shift.
                        </p>
                    </div>
                    <div class="col-lg-2">
                        <a href="{{url('/shift/create')}}"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="/shift/{{$item->id}}" method="post" class="d-inline cek">
                                    @method('delete')
                                    @csrf
                                    <button type="button"
