    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-10">
                        <h4 class="mt-0 header-title">Data Pembayaran</h4>
                        <p class="text-muted mb-4 font-13">Tabel berikut menyediakan informasi detail Pembayaran.
                        </p>
                    </div>
                    <div class="col-lg-2">
                        <a href="{{url('/bayar/create')}}"
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$item->perawat->nama_perawat}}</td>
                            <td>{{$item->pasien->nama_pasien}}</td>
                            <td class="edit_uang">Rp. {{number_format($item->jumlah_harga) }}</td>
