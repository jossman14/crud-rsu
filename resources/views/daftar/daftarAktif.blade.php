...
@section('judulSitus', "Halaman Manajemen Daftar Aktif Pasien")
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h2 class="text-center">Daftar Pasien Aktif</h2>
                <div class="row">
                    <div class="col-lg-4">
                        <div class="mt-4">
                            <div class="card" id="">
                ...
                <div class="row mt-4">
                    <div class="col-lg-10">
                        <h4 class="mt-0 header-title">Data Pasien Aktif</h4>
                ...
                <div class="row d-flex justify-content-center">
                    <div class="mt-4" id="html-content-holder">
                        <div class="card rounded alert alert-outline-dark alert-dark-shadow" id="">
                            <div class="card-body text-center">
                                <div class="">
                                    ...
                                    <form action="{{url('daftar_aktif',[$item->id])}} " method="post"
                                        ...
                                        @csrf
                                        <button type="button"
                                            class="btn m-1 btn-lg btn-info waves-effect waves-light text-light sa-warning-hapus btn-delete"><i
                                                class="mdi mdi-arrow-expand-right mr-1"></i>Lanjut ke Pasien
                                            berikutnya</button>
                                    </form>
                                    @endforeach
                                </div>
...
<script>
    $(document).ready(function(){
        ...
        $(document).on("click", "form.lanjut", function () {
            var form = $(this);
            console.log("clik nin gan")
            swal({
                title: "Apakah data sudah direkap?",
                text: "silahkan melanjutkan apabila sudah yakin!",
                type: "warning",
                showCancelButton: true,
                confirmButtonClass: "btn btn-success delete",
                cancelButtonClass: "btn btn-danger ml-2",
