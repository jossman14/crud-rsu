    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-10">
                        <h4 class="mt-0 header-title">Data Poliklinik</h4>
                        <p class="text-muted mb-4 font-13">Tabel berikut menyediakan informasi detail Poliklinik.
                        </p>
                    </div>
                    <div class="col-lg-2">
                        <a href="{{url('/poli/create')}}"
